from config import MIMIC_DATA_DIR, WAVEFORM_DIR, HELPFUL_DF_DIR, physio_cols_to_keep
import os
import pandas as pd
...
if __name__ == "__main__":
    ...
    chartevents_filtered = load_and_process_csv_for_hadm_ids(chartevents_path, hadm_ids, usecols=physio_cols_to_keep['chartevents'], source='chartevents')
