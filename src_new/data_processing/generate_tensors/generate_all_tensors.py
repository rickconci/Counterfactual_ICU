...
from create_context_tensors import create_context_tensors
...
def generate_all_tensors(
    ...
    logging.info("Step 1/3: Generating medication tensors ...")
    ...
    logging.info("Step 2/3: Generating physiological IC and prediction target tensors ...")
    ...
    logging.info("Step 3/3: Generating context tensors (physio + meds) ...")
    ...
    logging.info("All tensors generated successfully.")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate medication, physiological IC/targets, and context tensors "
