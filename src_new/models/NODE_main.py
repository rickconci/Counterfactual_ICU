...
def main(args):
    ...
    model = NODE(use_encoder=args.use_encoder,
                       ...
                       ODEnet_hidden_dim=args.ODEnet_hidden_dim,
                       ODEnet_depth=args.ODEnet_depth,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ODEnet_hidden_dim', type=int, default=300, help='Hidden dim for SDE NN  ')
    parser.add_argument('--ODEnet_depth', type=int, default=6, help='Num layers for SDE NN  ')
    ...
    parser.add_argument('--prior_tx_sigma', type=float, default=0.1,
    ...
    parser.add_argument('--encoder_ODENN_dims', type=int, default=64, help='Encoder output used by SDENN')

    # Default args _not be changed_
    parser.add_argument('--num_samples', type=int, default=1, help='Number of SDE samples- is affected if sigma >0 ')
    ...
    parser.add_argument('--final_activation', type=str, default='none', choices=['relu', 'none', 'tanh'],
                        help='Which nonlinearity to add as a final layer to the NN!')
    parser.add_argument('--normalise_for_ODENN', type=bool, default=True,
