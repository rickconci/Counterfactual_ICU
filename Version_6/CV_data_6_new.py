...
class PhysiologicalSDE_batched(torchsde.SDEIto):
    ...
    def create_treatment_effect(self):
        if self.confounder_type == 'visible':
            ...
            init_sv_transform  = 0.5+(self.params["confounding_sv"]-0.75)/0.1
...
if __name__ == '__main__':
    ...
    path = '/Users/riccardoconci/Local_documents/ACS submissions/THESIS/Counterfactual_ICU/Experiment_6/data'
