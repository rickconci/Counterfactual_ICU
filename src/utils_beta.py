...
class MLPSimple(nn.Module):
    def __init__(self, input_dim, output_dim, hidden_dim, depth, activations=None, dropout_p=None, final_activation=None, use_batch_norm=False, debug=False):
        super().__init__()
        self.debug = debug
        if self.debug:
            print(f"[DEBUG] MLPSimple __init__: input_dim={input_dim}, output_dim={output_dim}, hidden_dim={hidden_dim}, depth={depth}, use_batch_norm={use_batch_norm}")
