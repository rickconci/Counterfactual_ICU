...
class CVDataset(Dataset):
    def __init__(self,N, gamma,noise_std, t_span, t_treatment, seed):
        ...
        X, X_static, T, Y_fact, Y_cf, p, init, t_X, t_Y, expert_ODE_size = create_cv_data(N = N, gamma = gamma, noise_std = noise_std, t_span = t_span, t_treatment = t_treatment, seed = seed)
