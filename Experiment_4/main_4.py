...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=13, help='Random seed for initialization')
    ...
    parser.add_argument('--latent_dim', type=int, default=4, help='Latent dimension for the CDE')
    parser.add_argument('--hidden_dim', type=int, default=16, help='Hidden dimension across models')
    parser.add_argument('--use_whole_traj', type=bool, default=True, help='Whether to use the whole trajectory to convert from latent to observed or pointwise')
    ...
    ## SDE specific argrs
    parser.add_argument('--num_samples', type=int, default=2, help='Number of SDE samples  ')
    ...
    parser.add_argument('--mse_weighting', type=float, default=1, help='Defines the weighting to the KL loss for the variational encoder')
