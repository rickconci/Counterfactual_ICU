...
def main(args):
    ...
    sde_vae_model = SDE_VAE_Lightning(input_dim=2, output_dim=2, hidden_dim=args.hidden_dim, latent_dim=args.latent_dim,
    ...
    trainer.fit(sde_vae_model, cv_data_module)
    
    trainer.test(ckpt_path="best", test_dataloaders=cv_data_module.test_dataloader())
