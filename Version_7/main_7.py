...
if __name__ == '__main__':
    ...
    parser.add_argument('--plot_every', type=int, default=5, help='Plot every how many global steps? ')
    ...
    parser.add_argument('--SDEnet_hidden_dim', type=int, default=400, help='Hidden dim for SDE NN  ')
    parser.add_argument('--SDEnet_depth', type=int, default=5, help='Num layeres for SDE NN  ')
