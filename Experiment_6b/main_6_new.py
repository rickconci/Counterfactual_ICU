...
if __name__ == '__main__':
    ...
    parser.add_argument('--normalise', type=bool, default=True, help='Whether to normalise the data. Recommended ONLY if using an Encoder')
    ...
    # Model specific args
    parser.add_argument('--use_encoder', type=bool, default=True, help='Whether to encode the data until treatment and the decode or decode from the beginning!)')
